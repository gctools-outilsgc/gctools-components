...
const I18nPlugin = require('@gctools-components/i18n-translation-webpack-plugin');
...
module.exports = {
  ...
  entry: {
    ...
    pollyfills: require.resolve('./polyfills'),
    vendors: ['react', 'react-dom', 'material-ui', 'prop-types'],
  },
  output: {
    // The build folder.
    path: paths.appBuild,
  ...
  plugins: [
    ...
    // **** beginning of custom changes ****
    // Include localization support
    new I18nPlugin(),
    // ** added from PR 3145 (create-react-app)
